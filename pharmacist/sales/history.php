...
$sql = 'SELECT medicine_name, quantity_sold, amount_received, sold_date, pharmacist, created_at
        FROM sales
        WHERE pharmacist = ?';
...
<div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div>
        ...
        <p class="text-muted mb-0">View your recorded sales transactions.</p>
    </div>
</div>
...
<form method="get" class="row g-2 mb-4">
    ...
    <div class="col-md-4 d-flex gap-2">
        ...
        <?php if ($searchDate !== ''): ?>
            <a href="<?= url('pharmacist/sales/history.php') ?>" class="btn btn-outline-secondary">Clear</a>
        <?php endif; ?>
    </div>
</form>
...
<div class="card table-card">
    <div class="card-body p-0">
        ...
        <?php else: ?>
            <p class="text-muted p-4 mb-0">No sales found.</p>
        <?php endif; ?>
    </div>
</div>
